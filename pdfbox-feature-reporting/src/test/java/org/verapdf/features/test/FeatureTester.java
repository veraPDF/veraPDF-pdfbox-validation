...
public class FeatureTester {
    ...
    private static FeatureExtractionResult extractFeatures(String type)
        ...
        File testFile = new File(DIR_PATH + "pdf/" + type + ".pdf");
        PDDocument document = PDDocument.load(testFile, false, true);
        return PBFeatureParser.getFeaturesCollection(document, config);
    }
