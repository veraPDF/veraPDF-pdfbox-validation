...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/pdfbox-validation/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/pdfbox-validation/ "OPF Jenkins")
