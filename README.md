...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.27/job/pdfbox-validation/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.27/job/pdfbox-validation/ "OPF Jenkins")
