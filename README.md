...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.28rc/job/pdfbox-validation-jakarta/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.28rc/job/pdfbox-validation-jakarta/ "OPF Jenkins")
