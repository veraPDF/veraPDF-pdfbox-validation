 ...
 */
public class PBoxPDResource extends PBoxPDObject implements PDResource {

	private boolean inherited;

	protected PBoxPDResource(COSObjectable simplePDObject, final String type) {
	...
	protected PBoxPDResource(PDFontLike pdFontLike, final String type) {
